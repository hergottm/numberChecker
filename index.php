    					...
    					<div class="form">
                            <form action="validate.php" method="POST">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="fname" placeholder="First Name" maxlength="20" required>
                                    <input class="form-control" type="text" name="lname" placeholder="Last Name" maxlength="30" required>
                                    <input class="form-control" type="email" name="email" placeholder="Email (example@example.com)" required>
